...
select_evas_postpago = select([postpago_table.c.txt_sn,
                               ...
                               postpago_table.c.TIPO_EVALUACION]).where(and_(postpago_table.c.idform_cross.isnot(None),
...
select_evas_adm = select([adm_table.c.txt_sn,
                          adm_table.c.TipoLlamada.label('tipo_llamada'),
                          adm_table.c.motivo_llamada,
                          adm_table.c.idform_cross,
                          adm_table.c.USUARIO.label('evaluador'),
                          adm_table.c.CALIFICACION_FINAL,
                          adm_table.c.MALA_PRACTICA.label('detecta_mala_practica'),
                          adm_table.c.fecha_llamada,
                          adm_table.c.Fecha_monitoreo,
                          adm_table.c.TIPO_EVALUACION]).where(and_(adm_table.c.idform_cross.isnot(None),
...
select_evas_tec = select([tec_table.c.txt_sn,
                          tec_table.c.TipoLlamada.label('tipo_llamada'),
                          tec_table.c.motivo_llamada,
                          tec_table.c.idform_cross,
                          tec_table.c.USUARIO.label('evaluador'),
                          tec_table.c.CALIFICACION_FINAL,
                          tec_table.c.MALA_PRACTICA.label('detecta_mala_practica'),
                          tec_table.c.fecha_llamada,
                          tec_table.c.Fecha_monitoreo,
                          tec_table.c.TIPO_EVALUACION]).where(and_(tec_table.c.idform_cross.isnot(None),
                                                                   tec_table.c.MES_FLL == mes_auditoria(),
                                                                   tec_table.c.AÑO_FLL == year_auditoria(),
                                                                   tec_table.c.TIPO_EVALUACION.in_(('MONITOREO_CALIDAD_DYNAMICALL', 'MONITOREO_CRUZADO'))))  # , postpago_table.c.idform_cross.notin_(result)))
